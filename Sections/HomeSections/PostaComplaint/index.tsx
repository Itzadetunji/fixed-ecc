...
const PostaComplaint: React.FC = () => {
	return (
		<div className="lg:mt-48 bg-white items-center justify-center text-center relative -tracking-[0.02em]">
			<img
			...
			>
				<p className="text-white font-semibold text-[20px] sm:text-[30px] lg:text-[40px] xl:text-[48px] px-[15px]">
				...
				<div className="pt-[20px] sm:pt-[40px] lg:pt-[72px]">
					<button className="items-center justify-center text-center bg-blue-600 rounded-md lg:rounded-[10px] py-3 sm:py-4 px-[15px] sm:px-[30px] lg:px-[45px]">
						<Link href="/login">
