		...
		<div className="mt-48 bg-[#010C18] pb-[80px] md:pb-0 pt-10 md:h-[687px] w-full">
			...
			<div className="sm:space-x-10 md:space-x-10 lg:space-x-[120px] xl:space-x-[120px] flex sm:flex-row flex-col gap-8 sm:gap-5 mx-auto items-center justify-center mt-[36px] sm:mt-[122px]">
				<div
					...
					className="w-auto"
				>
					<p className="text-white text-center font-extrabold text-[35px] sm:text-[50px] md:text-[58px] xl:text-[72px]">30K+</p>
				...
				<div
					...
					className="w-auto"
				>
					<p className="text-white text-center font-extrabold text-[35px] sm:text-[50px] md:text-[58px] xl:text-[72px]">12K+</p>
					<p className="text-white text-center font-extralight text-[15px] sm:text-[13px] md:text-[15px] lg:text-[20px]">
				...
				<div
					...
					className="w-auto"
				>
					<p className="text-white text-center font-extrabold text-[35px] sm:text-[50px] md:text-[58px] xl:text-[72px]">200</p>
					<p className="text-white text-center font-extralight text-[15px] sm:text-[13px] md:text-[15px] lg:text-[20px]">
